      ...
      <div className="flex flex-col sm:flex-row gap-4">
        ...
        <div className="relative flex-1">
          ...
          <input
            ...
            className="w-full pl-10 pr-4 py-2 bg-gray-800/50 border border-gray-700/50 rounded-lg text-white font-inter placeholder-gray-500 focus:outline-hidden focus:border-gold/50 transition-colors"
          />
        </div>
                              ...
                              {confirmCancel === subscription.id ? (
                                <div className="flex items-center gap-2">
                                  <button
                                    ...
                                    className="px-2 py-1 text-xs bg-red-500/20 text-red-400 rounded-sm hover:bg-red-500/30 transition-colors disabled:opacity-50"
                                  >
                                ...
                                <button
                                  ...
                                  className="px-2 py-1 text-xs bg-gray-700/50 text-gray-300 rounded-sm hover:bg-red-500/20 hover:text-red-400 transition-colors"
                                >
                                  Cancel
                                </button>
                              )}
