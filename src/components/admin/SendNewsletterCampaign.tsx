      ...
      <div class="main-content">
        ...
        <div class="pricing-section">
          <div class="pricing-card">
            ...
            <div class="plan-price">Starting at $1,000</div>
            <div class="price-range">Price Range: $1,000 - $2,000</div>
          ...
          <div class="pricing-card" style="border-color: #ffa500; border-width: 3px">
            ...
            <div class="plan-price">Starting at $3,000</div>
            <div class="price-range">Price Range: $3,000 - $6,000</div>
        ...
        <div class="content">
            ...
            <div style="background: #FEF3C7; border-left: 4px solid #F59E0B; padding: 20px; margin: 30px 0; border-radius: 8px;">
                ...
                <div style="color: #78350F; font-size: 14px; line-height: 1.8;">
                    <p style="margin-bottom: 10px;"><strong>"Es muy caro"</strong> → Desde $1,000, menos que un stand en una feria</p>
            ...
            <div style="text-align: center; margin: 30px 0;">
                <p style="color: #4a5568; margin-bottom: 15px; font-size: 15px;">
                    <strong>Paquetes desde $1,000</strong> • <strong>Planes de Pago 50/50</strong>
                </p>
    ...
    <div class="container">
        ...
        <div class="content">
            ...
            <div style="background: #FEF3C7; border-left: 4px solid #F59E0B; padding: 20px; margin: 30px 0; border-radius: 8px;">
                ...
                <div style="color: #78350F; font-size: 14px; line-height: 1.8;">
                    <p style="margin-bottom: 10px;"><strong>"It's too expensive"</strong> → Starting at $1,000, less than a trade show booth</p>
            ...
            <div style="text-align: center; margin: 30px 0;">
                <p style="color: #4a5568; margin-bottom: 15px; font-size: 15px;">
                    <strong>Packages starting at $1,000</strong> • <strong>50/50 Payment Plans</strong>
                </p>
                <p style="color: #6B7280; font-size: 13px; line-height: 1.6;">
