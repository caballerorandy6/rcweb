export default function ClientLoginSkeleton() {
  return (
    <div className="min-h-screen flex items-center justify-center bg-gray-900 px-4 py-8">
      <div className="w-full max-w-md">
        <div className="relative">
          ...
          <div className="relative space-y-6 bg-linear-to-br from-gray-900/95 to-gray-800/95 p-8 rounded-2xl shadow-2xl backdrop-blur-xs border border-gray-700/50 animate-pulse">
            ...
            <div className="relative">
              {/* Title Skeleton */}
              <div className="h-12 bg-gray-700 rounded-lg mb-4 mx-auto w-2/3"></div>
              {/* Divider Skeleton */}
              <div className="h-1 bg-gray-700 rounded-full mx-auto w-24 mb-4"></div>
              {/* Subtitle Skeleton */}
              <div className="h-4 bg-gray-700 rounded-sm mx-auto w-1/2"></div>
            </div>
            ...
            <div className="text-center">
              <div className="h-4 bg-gray-700 rounded-sm mx-auto w-3/4"></div>
            </div>
          </div>
        </div>
      </div>
