  ...
  return (
    <div className="min-h-screen bg-gray-900 p-8 py-24 lg:py-32 animate-pulse">
      <div className="max-w-7xl mx-auto">
        {/* Header Skeleton */}
        <div className="h-10 w-64 bg-gray-800 rounded-sm mb-8"></div>
              ...
              <thead>
                <tr className="bg-gray-700">
                  <th className="px-6 py-3">
                    <div className="h-4 w-12 bg-gray-600 rounded-sm"></div>
                  </th>
                  <th className="px-6 py-3">
                ...
                {[1, 2, 3, 4, 5].map((i) => (
                  <tr key={i}>
                    <td className="px-6 py-4">
                      <div className="h-5 w-20 bg-gray-700 rounded-sm"></div>
                    </td>
                    <td className="px-6 py-4">
                      <div className="h-5 w-32 bg-gray-700 rounded-sm mb-2"></div>
                    ...
                    <td className="px-6 py-4">
                      <div className="flex gap-2">
                        <div className="h-6 w-16 bg-gray-700 rounded-sm"></div>
                        <div className="h-6 w-16 bg-gray-700 rounded-sm"></div>
                      </div>
                    </td>
                    <td className="px-6 py-4">
                      <div className="h-6 w-24 bg-gray-700 rounded-sm"></div>
                    </td>
                    <td className="px-6 py-4">
                      <div className="h-8 w-32 bg-gray-700 rounded-sm"></div>
                    </td>
                  </tr>
                ))}
              </tbody>
