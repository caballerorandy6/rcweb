export default function PaymentSuccessSkeleton() {
  return (
    <div className="min-h-screen bg-linear-to-b from-gray-900 to-black flex items-center justify-center px-4 py-24 sm:py-32 animate-pulse">
      <div className="max-w-2xl w-full">
        ...
        <div className="bg-gray-900/60 backdrop-blur-md rounded-2xl border border-gray-700/50 p-8 sm:p-12 shadow-2xl">
          {/* Title Skeleton */}
          <div className="text-center mb-8">
            <div className="h-10 w-64 bg-gray-800 rounded-sm mx-auto mb-4"></div>
            <div className="h-6 w-96 bg-gray-800 rounded-sm mx-auto"></div>
          </div>
          ...
          <div className="bg-linear-to-r from-gold/10 to-gold/5 rounded-xl p-6 mb-8 border border-gold/20">
            <div className="h-5 w-32 bg-gray-700 rounded-sm mb-3"></div>
          ...
          <div className="bg-gray-800/30 rounded-xl p-6 mb-8">
            <div className="h-6 w-32 bg-gray-700 rounded-sm mb-4"></div>
            <div className="space-y-3">
              {[1, 2, 3].map((i) => (
                <div key={i} className="flex items-start gap-3">
                  <div className="h-6 w-6 bg-gray-700 rounded-full shrink-0"></div>
        ...
        <div className="text-center mt-8">
          <div className="h-4 w-64 bg-gray-800 rounded-sm mx-auto"></div>
        </div>
      </div>
    </div>
  );
