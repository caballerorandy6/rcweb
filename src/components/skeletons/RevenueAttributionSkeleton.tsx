    ...
    <div className="bg-gray-800/80 rounded-xl p-4 sm:p-6 border border-gray-700/50 animate-pulse">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center gap-2 sm:gap-3 mb-5">
        <div className="flex items-center gap-3">
          <CurrencyDollarIcon className="w-5 h-5 sm:w-6 sm:h-6 text-gold/50 shrink-0" />
          <div className="h-7 w-44 bg-gray-700 rounded-sm" />
        </div>
        <div className="sm:ml-auto">
          <div className="h-6 w-24 bg-gray-700 rounded-sm" />
        </div>
      </div>
      ...
      <div className="grid md:grid-cols-2 gap-6">
        ...
        <div>
          <div className="h-4 w-32 bg-gray-700 rounded-sm mb-3" />
          <div className="space-y-2">
            {[1, 2].map((i) => (
              <div key={i} className="p-2.5 bg-gray-700/30 rounded-lg">
                <div className="flex justify-between">
                  <div>
                    <div className="h-4 w-20 bg-gray-700 rounded-sm mb-1" />
