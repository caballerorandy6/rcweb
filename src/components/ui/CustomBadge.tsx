  ...
  return (
    ...
    >
      <span className="relative inline-flex overflow-hidden rounded-full p-[1px] transition-transform duration-200 ease-in-out hover:scale-105">
        ...
        <div className="inline-flex items-center justify-center w-full px-3 py-1 text-sm text-gold-darker bg-gold rounded-full cursor-pointer dark:bg-gray-800 dark:text-white/80 backdrop-blur-3xl whitespace-nowrap font-inter">
          {children}
        </div>
      </span>
    </Link>
