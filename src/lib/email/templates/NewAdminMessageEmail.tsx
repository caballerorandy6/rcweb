...
export interface NewAdminMessageEmailProps {
  customerName: string;
  projectCode: string;
  planName: string;
  message: string;
...
export const NewAdminMessageEmail: React.FC<NewAdminMessageEmailProps> = ({
  customerName,
  projectCode,
  planName,
  message,
      ...
      <Body style={styles.body}>
        <Container style={styles.container}>
          ...
          <Section style={styles.header}>
            <Heading style={styles.headerTitle}>New Message About Your Project</Heading>
          ...
          <Section style={styles.content}>
            ...
            <Text style={styles.paragraph}>
              We have a message for you regarding your <strong>{planName}</strong> project.
            </Text>
            ...
            <Section style={styles.messageBox}>
              <Text style={styles.messageTitle}>Message from RC Web Solutions:</Text>
            ...
            <Text style={styles.footerText}>
              You can reply to this message directly from your client portal. If you
...
const styles: Record<string, React.CSSProperties> = {
  ...
  header: {
    ...
    borderBottom: `4px solid ${EMAIL_COLORS.goldDark}`,
  },
  headerTitle: {
  ...
  infoBox: {
    ...
    padding: "24px",
    margin: "32px 0",
    border: `1px solid ${EMAIL_COLORS.goldLight}`,
  },
  infoTitle: {
    color: EMAIL_COLORS.dark,
    fontSize: "16px",
...
export default NewAdminMessageEmail;
