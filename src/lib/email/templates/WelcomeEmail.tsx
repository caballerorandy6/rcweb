      ...
      <Body style={styles.body}>
        <Container style={styles.container}>
          ...
          <Section style={styles.header}>
            <Heading style={styles.headerTitle}>Welcome, {customerName}!</Heading>
            <Text style={styles.headerSubtitle}>Your client portal is ready</Text>
          </Section>
          ...
          <Section style={styles.content}>
            ...
            <Text style={styles.paragraph}>
              ...
              access all your projects, invoices, and project updates in one place.
            </Text>
            ...
            <Section style={styles.featuresBox}>
              <Heading as="h3" style={styles.featuresTitle}>
                What you can do:
              </Heading>
              <ul style={styles.featuresList}>
                <li style={styles.listItem}>
                  View all your projects and their progress
                </li>
                <li style={styles.listItem}>Track milestones in real-time</li>
                <li style={styles.listItem}>
