export default function ContactManagementSkeleton() {
  return (
    <div className="min-h-screen bg-gray-900 py-24 lg:py-32 px-4 animate-pulse">
      <div className="max-w-7xl mx-auto">
        ...
        {/* Search Skeleton */}
        <div className="mb-6">
          <div className="h-12 w-full md:w-96 bg-gray-800 rounded-lg"></div>
        </div>
