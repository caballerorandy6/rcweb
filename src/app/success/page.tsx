    ...
    <div className="min-h-screen bg-gray-900 flex items-center justify-center px-4">
      <div className="max-w-md w-full text-center">
        ...
        <div className="flex gap-4">
          <Link
            href="/"
            className="flex-1 bg-gold text-gray-900 py-3 rounded-lg font-semibold hover:bg-gold/90 transition-colors text-center"
          >
            Back to Home
          </Link>
          <Link
            href="/#contact"
            className="flex-1 border border-gold/50 text-gold py-3 rounded-lg hover:bg-gold/10 transition-colors text-center"
          >
            Contact Us
          </Link>
        </div>
