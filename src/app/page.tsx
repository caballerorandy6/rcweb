...
export const metadata: Metadata = {
  ...
  description:
    "Houston TX web developer Randy Caballero builds custom websites and web apps for small businesses. Next.js, React, bilingual English & Spanish. From $1,000. Free consultation.",
  alternates: {
